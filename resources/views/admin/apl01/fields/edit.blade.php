...
@section('page_title', 'Edit Form Field')
@section('page_description', $field->field_label)

@section('content')
    <form action="{{ route('admin.apl01-fields.update', $field) }}" method="POST">
        @csrf
        @method('PUT')
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <select id="scheme_id" name="scheme_id" required
                                ...
                                @foreach($schemes as $scheme)
                                    <option value="{{ $scheme->id }}" {{ old('scheme_id', $field->scheme_id) == $scheme->id ? 'selected' : '' }}>
                        ...
                        <div>
                            ...
                            <input type="text" id="field_name" name="field_name" value="{{ old('field_name', $field->field_name) }}" required
                        ...
                        <div>
                            ...
                            <input type="text" id="field_label" name="field_label" value="{{ old('field_label', $field->field_label) }}" required
                        ...
                        <div>
                            ...
                            <textarea id="field_description" name="field_description" rows="2"
                                ...
                                placeholder="Additional instructions or help text...">{{ old('field_description', $field->field_description) }}</textarea>
                        ...
                        <div>
                            ...
                            <select id="field_type" name="field_type" required
                                ...
                                <option value="email" {{ old('field_type', $field->field_type) == 'email' ? 'selected' : '' }}>Email</option>
                                ...
                                <option value="checkbox" {{ old('field_type', $field->field_type) == 'checkbox' ? 'selected' : '' }}>Checkbox (Single)</option>
                                <option value="checkboxes" {{ old('field_type', $field->field_type) == 'checkboxes' ? 'selected' : '' }}>Checkboxes (Multiple)</option>
                                <option value="file" {{ old('field_type', $field->field_type) == 'file' ? 'selected' : '' }}>File Upload</option>
                                <option value="image" {{ old('field_type', $field->field_type) == 'image' ? 'selected' : '' }}>Image Upload</option>
                                <option value="url" {{ old('field_type', $field->field_type) == 'url' ? 'selected' : '' }}>URL</option>
                                <option value="phone" {{ old('field_type', $field->field_type) == 'phone' ? 'selected' : '' }}>Phone Number</option>
                                <option value="rating" {{ old('field_type', $field->field_type) == 'rating' ? 'selected' : '' }}>Rating (1-5)</option>
                                <option value="yesno" {{ old('field_type', $field->field_type) == 'yesno' ? 'selected' : '' }}>Yes/No</option>
                                <option value="section_header" {{ old('field_type', $field->field_type) == 'section_header' ? 'selected' : '' }}>Section Header</option>
                                <option value="html" {{ old('field_type', $field->field_type) == 'html' ? 'selected' : '' }}>HTML Content</option>
                            </select>
                            @error('field_type')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" id="section" name="section" value="{{ old('section', $field->section) }}"
                        ...
                        <div>
                            ...
                            <input type="number" id="order" name="order" value="{{ old('order', $field->order) }}" min="0"
                        ...
                        <div>
                            ...
                            <input type="number" id="field_width" name="field_width" value="{{ old('field_width', $field->field_width ?? 12) }}" min="1" max="12"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                        ...
                        <div>
                            ...
                            <input type="text" id="help_text" name="help_text" value="{{ old('help_text', $field->help_text) }}"
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" id="is_required" name="is_required" value="1" {{ old('is_required', $field->is_required) ? 'checked' : '' }}
                        ...
                        <!-- Is Enabled -->
                        <div class="flex items-center">
                            <input type="checkbox" id="is_enabled" name="is_enabled" value="1" {{ old('is_enabled', $field->is_enabled) ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                        ...
                        <!-- Is Visible -->
                        <div class="flex items-center">
                            <input type="checkbox" id="is_visible" name="is_visible" value="1" {{ old('is_visible', $field->is_visible) ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
