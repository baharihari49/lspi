...
@section('page_title', 'Edit TUK')
@section('page_description', 'Update Tempat Uji Kompetensi information')

@section('content')
    <form action="{{ route('admin.tuk.update', $tuk) }}" method="POST" class="w-full">
        @csrf
        @method('PUT')
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" id="code" name="code" value="{{ old('code', $tuk->code) }}" required maxlength="255"
                        ...
                        <div>
                            ...
                            <select id="type" name="type" required
                                ...
                                <option value="permanent" {{ old('type', $tuk->type) == 'permanent' ? 'selected' : '' }}>Permanent</option>
                                <option value="temporary" {{ old('type', $tuk->type) == 'temporary' ? 'selected' : '' }}>Temporary</option>
                                <option value="mobile" {{ old('type', $tuk->type) == 'mobile' ? 'selected' : '' }}>Mobile</option>
                            </select>
                            @error('type')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name', $tuk->name) }}" required maxlength="255"
                        ...
                        <div>
                            ...
                            <select id="status_id" name="status_id"
                                ...
                                @foreach($statuses as $status)
                                    <option value="{{ $status->id }}" {{ old('status_id', $tuk->status_id) == $status->id ? 'selected' : '' }}>
                                        {{ $status->label }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <select id="manager_id" name="manager_id"
                                ...
                                @foreach($users as $user)
                                    <option value="{{ $user->id }}" {{ old('manager_id', $tuk->manager_id) == $user->id ? 'selected' : '' }}>
                                        {{ $user->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="description" name="description" rows="3"
                                ...
                                placeholder="Brief description of the test center">{{ old('description', $tuk->description) }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="address" name="address" rows="3" required
                                ...
                                placeholder="Full address of the test center">{{ old('address', $tuk->address) }}</textarea>
                            @error('address')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" id="city" name="city" value="{{ old('city', $tuk->city) }}" required maxlength="255"
                        ...
                        <div>
                            ...
                            <input type="text" id="province" name="province" value="{{ old('province', $tuk->province) }}" required maxlength="255"
                        ...
                        <div>
                            ...
                            <input type="text" id="postal_code" name="postal_code" value="{{ old('postal_code', $tuk->postal_code) }}" maxlength="10"
                        ...
                        <div>
                            ...
                            <input type="number" id="latitude" name="latitude" value="{{ old('latitude', $tuk->latitude) }}" step="0.000001" min="-90" max="90"
                        ...
                        <div>
                            ...
                            <input type="number" id="longitude" name="longitude" value="{{ old('longitude', $tuk->longitude) }}" step="0.000001" min="-180" max="180"
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" id="phone" name="phone" value="{{ old('phone', $tuk->phone) }}" maxlength="255"
                        ...
                        <div>
                            ...
                            <input type="email" id="email" name="email" value="{{ old('email', $tuk->email) }}" maxlength="255"
                        ...
                        <div>
                            ...
                            <input type="text" id="pic_name" name="pic_name" value="{{ old('pic_name', $tuk->pic_name) }}" maxlength="255"
                        ...
                        <div>
                            ...
                            <input type="text" id="pic_phone" name="pic_phone" value="{{ old('pic_phone', $tuk->pic_phone) }}" maxlength="255"
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input type="number" id="capacity" name="capacity" value="{{ old('capacity', $tuk->capacity) }}" required min="0"
                        ...
                        <div>
                            ...
                            <input type="number" id="room_count" name="room_count" value="{{ old('room_count', $tuk->room_count) }}" required min="0"
                        ...
                        <div>
                            ...
                            <input type="number" id="area_size" name="area_size" value="{{ old('area_size', $tuk->area_size) }}" step="0.01" min="0"
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div>
                        <label class="flex items-center gap-3 cursor-pointer">
                            <input type="checkbox" name="is_active" value="1" {{ old('is_active', $tuk->is_active) ? 'checked' : '' }}
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        ...
                        <div class="space-y-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-900">{{ $tuk->updated_at->format('d M Y, H:i') }}</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <ul class="text-sm text-blue-800 space-y-1">
                                    ...
                                    <li>• Update location if changed</li>
                                    <li>• Keep contact info current</li>
                                    <li>• Review facility capacity</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        <div class="space-y-3">
                            <button type="submit" class="w-full flex items-center justify-center gap-2 px-6 py-3 bg-blue-900 hover:bg-blue-800 text-white rounded-lg font-semibold transition">
                                ...
                                <span>Update TUK</span>
                            </button>
                            <a href="{{ route('admin.tuk.show', $tuk) }}" class="w-full flex items-center justify-center gap-2 px-6 py-3 bg-gray-200 hover:bg-gray-300 text-gray-900 rounded-lg font-semibold transition">
