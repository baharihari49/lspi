...
@section('page_description', 'Update user information and roles')
    ...
    <form action="{{ route('admin.users.update', $user) }}" method="POST" class="w-full">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <!-- User Info -->
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <h3 class="text-sm font-semibold text-gray-600 uppercase tracking-wider mb-3">User Info</h3>
                    <div class="space-y-2 text-sm">
                        <div class="flex justify-between">
                            <span class="text-gray-600">UUID:</span>
                            <span class="font-mono text-xs text-gray-900">{{ substr($user->uuid, 0, 8) }}...</span>
                        </div>
                        <div class="flex justify-between">
                        ...
                        <div class="flex justify-between">
                            ...
                            <span class="font-semibold text-gray-900">{{ $user->updated_at->format('d M Y') }}</span>
                        </div>
                        @if($user->last_login)
                            <div class="flex justify-between">
                                <span class="text-gray-600">Last Login:</span>
                                <span class="font-semibold text-gray-900">{{ $user->last_login->format('d M Y H:i') }}</span>
                            </div>
                        @endif
                    </div>
                </div>
