...
@section('content')
    <form action="{{ route('admin.events.update', $event) }}" method="POST" class="w-full">
        @csrf
        @method('PUT')
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" id="code" name="code" value="{{ old('code', $event->code) }}" required maxlength="255"
                        ...
                        <div>
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name', $event->name) }}" required maxlength="255"
                                ...
                                placeholder="Cth: Sertifikasi Pengelolaan Jurnal Elektronik - Batch 1">
                            @error('name')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <select id="event_type" name="event_type" required
                                ...
                                <option value="certification" {{ old('event_type', $event->event_type) == 'certification' ? 'selected' : '' }}>Sertifikasi</option>
                                <option value="training" {{ old('event_type', $event->event_type) == 'training' ? 'selected' : '' }}>Pelatihan</option>
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="4"
                                ...
                                placeholder="Deskripsi event...">{{ old('description', $event->description) }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="date" id="registration_start" name="registration_start" value="{{ old('registration_start', $event->registration_start?->format('Y-m-d')) }}"
                            ...
                            <div>
                                ...
                                <input type="date" id="registration_end" name="registration_end" value="{{ old('registration_end', $event->registration_end?->format('Y-m-d')) }}"
                    ...
                    <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <select id="scheme_id" name="scheme_id"
                                    ...
                                    @foreach(\App\Models\Scheme::orderBy('name')->get() as $scheme)
                                        <option value="{{ $scheme->id }}" {{ old('scheme_id', $event->scheme_id) == $scheme->id ? 'selected' : '' }}>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="number" id="registration_fee" name="registration_fee" value="{{ old('registration_fee', $event->registration_fee) }}" min="0" step="1000"
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" id="location" name="location" value="{{ old('location', $event->location) }}" maxlength="255"
                        ...
                        <div>
                            ...
                            <textarea id="location_address" name="location_address" rows="3"
                                ...
                                placeholder="Alamat lengkap lokasi event...">{{ old('location_address', $event->location_address) }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea id="notes" name="notes" rows="3"
                                ...
                                placeholder="Catatan internal (tidak terlihat peserta)...">{{ old('notes', $event->notes) }}</textarea>
                            @error('notes')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div class="lg:sticky lg:top-0 space-y-6">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        <div class="space-y-3">
                            ...
                            <a href="{{ route('admin.events.show', $event) }}" class="w-full flex items-center justify-center gap-2 px-6 py-3 bg-gray-200 hover:bg-gray-300 text-gray-900 rounded-lg font-semibold transition">
