                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <select id="event_type" name="event_type" required
                                ...
                                <option value="certification" {{ old('event_type', $event->event_type) == 'certification' ? 'selected' : '' }}>Certification</option>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea id="location_address" name="location_address" rows="3"
                                ...
                                placeholder="Full address of the event venue...">{{ old('location_address', $event->location_address) }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea id="notes" name="notes" rows="3"
                                ...
                                placeholder="Internal notes (not visible to participants)...">{{ old('notes', $event->notes) }}</textarea>
                            @error('notes')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
