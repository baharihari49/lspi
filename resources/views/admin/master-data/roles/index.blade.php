...
@section('content')
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        <div class="px-6 py-4 border-b border-gray-200">
            ...
            <!-- Search Box -->
            <form method="GET" action="{{ route('admin.master-roles.index') }}" class="flex gap-2">
                ...
                @if($search)
                    <a href="{{ route('admin.master-roles.index') }}" class="px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-900 rounded-lg font-semibold transition">
                        Clear
                    </a>
                @endif
            </form>
