...
@section('title', 'Create Assessor')

@php
    $active = 'assessors';
@endphp

@section('page_title', 'Create New Assessor')
@section('page_description', 'Add a new assessor to the system')

@section('content')
    <form action="{{ route('admin.assessors.store') }}" method="POST" enctype="multipart/form-data" class="w-full">
        @csrf
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <!-- ID Card Number -->
                        <div>
                            <label for="id_card_number" class="block text-sm font-semibold text-gray-700 mb-2">ID Card Number (NIK) *</label>
                            <input type="text" id="id_card_number" name="id_card_number" value="{{ old('id_card_number') }}" required maxlength="16"
                        ...
                        <!-- Birth Place -->
                        <div>
                            <label for="birth_place" class="block text-sm font-semibold text-gray-700 mb-2">Birth Place *</label>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <!-- Registration Date -->
                        <div>
                            <label for="registration_date" class="block text-sm font-semibold text-gray-700 mb-2">Registration Date *</label>
                            <input type="date" id="registration_date" name="registration_date" value="{{ old('registration_date', now()->format('Y-m-d')) }}" required
                        ...
                        <!-- Registration Status -->
                        <div>
                            <label for="registration_status" class="block text-sm font-semibold text-gray-700 mb-2">Registration Status *</label>
                            <select id="registration_status" name="registration_status" required
                                ...
                                <option value="inactive" {{ old('registration_status') === 'inactive' ? 'selected' : '' }}>Inactive</option>
                                <option value="suspended" {{ old('registration_status') === 'suspended' ? 'selected' : '' }}>Suspended</option>
                        ...
                        <div class="md:col-span-2">
                            <label class="flex items-center gap-3 cursor-pointer">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-600">Assessor is active and can perform assessments</p>
                                </div>
                            </label>
                        </div>
                    </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sticky top-0">
                    ...
                    <div class="space-y-3">
                        ...
                        <a href="{{ route('admin.assessors.index') }}" class="block w-full h-12 px-4 bg-gray-200 text-gray-700 font-semibold rounded-lg hover:bg-gray-300 text-center leading-[3rem] transition-all">
                            Cancel
                        </a>
                    </div>
