...
@section('title', 'Edit Assessee')

@php
    $active = 'assessees';
@endphp

@section('page_title', 'Edit Assessee')
@section('page_description', 'Update assessee information and verification status')

@section('content')
    <form action="{{ route('admin.assessees.update', $assessee) }}" method="POST" enctype="multipart/form-data" class="w-full">
        @csrf
        @method('PUT')
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <select id="user_id" name="user_id" required
                                ...
                                @foreach($users as $user)
                                    <option value="{{ $user->id }}" {{ old('user_id', $assessee->user_id) == $user->id ? 'selected' : '' }}>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" id="registration_number" name="registration_number" value="{{ old('registration_number', $assessee->registration_number) }}"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" id="full_name" name="full_name" value="{{ old('full_name', $assessee->full_name) }}" required
                        ...
                        <div>
                            ...
                            <input type="text" id="id_number" name="id_number" value="{{ old('id_number', $assessee->id_number) }}" required maxlength="20"
                        ...
                        <div>
                            ...
                            <select id="id_type" name="id_type" required
                                ...
                                <option value="ktp" {{ old('id_type', $assessee->id_type) === 'ktp' ? 'selected' : '' }}>KTP</option>
                                <option value="passport" {{ old('id_type', $assessee->id_type) === 'passport' ? 'selected' : '' }}>Passport</option>
                                <option value="kitas" {{ old('id_type', $assessee->id_type) === 'kitas' ? 'selected' : '' }}>KITAS</option>
                            </select>
                            @error('id_type')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="text" id="place_of_birth" name="place_of_birth" value="{{ old('place_of_birth', $assessee->place_of_birth) }}"
                        ...
                        <div>
                            ...
                            <input type="date" id="date_of_birth" name="date_of_birth" value="{{ old('date_of_birth', $assessee->date_of_birth?->format('Y-m-d')) }}"
                        ...
                        <div>
                            ...
                            <select id="gender" name="gender"
                                ...
                                <option value="male" {{ old('gender', $assessee->gender) === 'male' ? 'selected' : '' }}>Male</option>
                                <option value="female" {{ old('gender', $assessee->gender) === 'female' ? 'selected' : '' }}>Female</option>
                            </select>
                            @error('gender')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <select id="marital_status" name="marital_status"
                                ...
                                <option value="single" {{ old('marital_status', $assessee->marital_status) === 'single' ? 'selected' : '' }}>Single</option>
                                <option value="married" {{ old('marital_status', $assessee->marital_status) === 'married' ? 'selected' : '' }}>Married</option>
                                <option value="divorced" {{ old('marital_status', $assessee->marital_status) === 'divorced' ? 'selected' : '' }}>Divorced</option>
                                <option value="widowed" {{ old('marital_status', $assessee->marital_status) === 'widowed' ? 'selected' : '' }}>Widowed</option>
                            </select>
                        ...
                        <div>
                            ...
                            <input type="text" id="nationality" name="nationality" value="{{ old('nationality', $assessee->nationality) }}"
                        ...
                        @if($assessee->photo)
                            <div class="md:col-span-2">
                                ...
                                <img src="{{ asset('storage/' . $assessee->photo) }}" alt="{{ $assessee->full_name }}" class="w-32 h-32 object-cover rounded-lg border border-gray-200">
                            </div>
                        @endif

                        <!-- Photo -->
                        <div class="md:col-span-2">
                            <label for="photo" class="block text-sm font-semibold text-gray-700 mb-2">{{ $assessee->photo ? 'Change Photo' : 'Photo' }}</label>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" id="mobile" name="mobile" value="{{ old('mobile', $assessee->mobile) }}"
                        ...
                        <div>
                            ...
                            <input type="text" id="phone" name="phone" value="{{ old('phone', $assessee->phone) }}"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="email" id="email" name="email" value="{{ old('email', $assessee->email) }}"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea id="address" name="address" rows="3"
                                class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none @error('address') border-red-500 @enderror">{{ old('address', $assessee->address) }}</textarea>
                            @error('address')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" id="city" name="city" value="{{ old('city', $assessee->city) }}"
                        ...
                        <div>
                            ...
                            <input type="text" id="province" name="province" value="{{ old('province', $assessee->province) }}"
                        ...
                        <div>
                            ...
                            <input type="text" id="postal_code" name="postal_code" value="{{ old('postal_code', $assessee->postal_code) }}" maxlength="10"
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" id="current_company" name="current_company" value="{{ old('current_company', $assessee->current_company) }}"
                        ...
                        <div>
                            ...
                            <input type="text" id="current_position" name="current_position" value="{{ old('current_position', $assessee->current_position) }}"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" id="current_industry" name="current_industry" value="{{ old('current_industry', $assessee->current_industry) }}"
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" id="emergency_contact_name" name="emergency_contact_name" value="{{ old('emergency_contact_name', $assessee->emergency_contact_name) }}"
                        ...
                        <div>
                            ...
                            <input type="text" id="emergency_contact_relation" name="emergency_contact_relation" value="{{ old('emergency_contact_relation', $assessee->emergency_contact_relation) }}"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" id="emergency_contact_phone" name="emergency_contact_phone" value="{{ old('emergency_contact_phone', $assessee->emergency_contact_phone) }}"
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div>
                        ...
                        <textarea id="bio" name="bio" rows="4"
                            class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none @error('bio') border-red-500 @enderror">{{ old('bio', $assessee->bio) }}</textarea>
                        @error('bio')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select id="verification_status" name="verification_status"
                                ...
                                <option value="pending" {{ old('verification_status', $assessee->verification_status) === 'pending' ? 'selected' : '' }}>Pending</option>
                                <option value="verified" {{ old('verification_status', $assessee->verification_status) === 'verified' ? 'selected' : '' }}>Verified</option>
                                <option value="rejected" {{ old('verification_status', $assessee->verification_status) === 'rejected' ? 'selected' : '' }}>Rejected</option>
                                <option value="suspended" {{ old('verification_status', $assessee->verification_status) === 'suspended' ? 'selected' : '' }}>Suspended</option>
                            </select>
                        ...
                        <!-- Verification Notes -->
                        <div class="md:col-span-2">
                            <label for="verification_notes" class="block text-sm font-semibold text-gray-700 mb-2">Verification Notes</label>
                            <textarea id="verification_notes" name="verification_notes" rows="3"
                                class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none @error('verification_notes') border-red-500 @enderror">{{ old('verification_notes', $assessee->verification_notes) }}</textarea>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sticky top-0">
                    ...
                    <div class="mt-6 pt-6 border-t border-gray-200">
                        ...
                        <label class="flex items-center gap-3 cursor-pointer">
                            <input type="checkbox" name="is_active" value="1" {{ old('is_active', $assessee->is_active) ? 'checked' : '' }}
