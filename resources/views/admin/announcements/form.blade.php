<div class="space-y-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <textarea
            ...
            required
            rows="12"
            class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none resize-y @error('content') border-red-500 @enderror"
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <input
                    ...
                    class="w-full md:w-1/2 h-12 px-4 rounded-lg border border-gray-300 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 outline-none @error('published_at') border-red-500 @enderror"
                >
    ...
    <div class="flex items-center gap-4">
        <button
            type="submit"
            class="flex items-center gap-2 px-6 py-3 bg-purple-600 hover:bg-purple-700 text-white rounded-lg font-semibold transition"
        >
            <span class="material-symbols-outlined">save</span>
            <span>{{ $announcement ? 'Perbarui Pengumuman' : 'Simpan Pengumuman' }}</span>
        </button>
        <a
