...
@section('page_title', 'Create New Payment')
@section('page_description', 'Create a new payment transaction')
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <select name="payer_type" id="payerType" required
                                ...
                                <option value="assessee" {{ old('payer_type') === 'assessee' ? 'selected' : '' }}>Assessee</option>
                                <option value="organization" {{ old('payer_type') === 'organization' ? 'selected' : '' }}>Organization</option>
                                <option value="individual" {{ old('payer_type') === 'individual' ? 'selected' : '' }}>Individual</option>
                            </select>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="payer_address" value="{{ old('payer_address') }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <select name="payable_type" id="payableType" required
                                ...
                                <option value="event" {{ old('payable_type') === 'event' ? 'selected' : '' }}>Event</option>
                                <option value="assessment" {{ old('payable_type') === 'assessment' ? 'selected' : '' }}>Assessment</option>
                                <option value="certificate_renewal" {{ old('payable_type') === 'certificate_renewal' ? 'selected' : '' }}>Certificate Renewal</option>
                                <option value="other" {{ old('payable_type') === 'other' ? 'selected' : '' }}>Other</option>
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="notes" rows="3"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none">{{ old('notes') }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="mt-6 pt-6 border-t border-gray-200 space-y-2">
                        ...
                        <div class="flex justify-between text-sm">
                            ...
                            <span class="font-medium text-green-600" id="discountDisplay">- Rp 0</span>
                        </div>
                        <div class="flex justify-between text-sm">
                            <span class="text-gray-600">Tax</span>
                            <span class="font-medium text-gray-900" id="taxDisplay">Rp 0</span>
                        </div>
                        <div class="flex justify-between text-lg font-bold pt-2 border-t border-gray-200">
                            <span class="text-gray-900">Total Amount</span>
                            <span class="text-blue-900" id="totalDisplay">Rp 0</span>
                        </div>
                    </div>

                    <input type="hidden" name="subtotal" id="subtotalInput" value="0">
                    <input type="hidden" name="admin_fee" id="adminFeeInput" value="0">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="number" name="discount_percentage" id="discountPercentage" value="{{ old('discount_percentage', 0) }}" min="0" max="100" step="0.01"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none">
                        </div>

                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Tax Percentage (%)</label>
                            <input type="number" name="tax_percentage" id="taxPercentage" value="{{ old('tax_percentage', 0) }}" min="0" max="100" step="0.01"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none">
                        </div>
                    </div>
                </div>
