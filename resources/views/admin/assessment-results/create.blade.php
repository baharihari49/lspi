...
@section('title', 'Create Assessment Result')

@php
    $active = 'assessment-results';
@endphp

@section('page_title', 'Create Assessment Result')
@section('page_description', 'Generate final assessment result and certificate')

@section('content')
    <form action="{{ route('admin.assessment-results.store') }}" method="POST" class="w-full">
        @csrf
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="space-y-4">
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                <p class="text-xs text-gray-600">Assessment Title</p>
                                <p class="font-semibold text-gray-900">{{ $assessment->title }}</p>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                <p class="text-xs text-gray-600">Assessment Date</p>
                                <p class="font-semibold text-gray-900">{{ $assessment->completed_at ? $assessment->completed_at->format('d M Y') : '-' }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        ...
                        <div>
                            ...
                            <select id="final_result" name="final_result" required
                                ...
                                <option value="competent" {{ old('final_result') === 'competent' ? 'selected' : '' }}>Competent</option>
                                <option value="not_yet_competent" {{ old('final_result') === 'not_yet_competent' ? 'selected' : '' }}>Not Yet Competent</option>
                                <option value="requires_reassessment" {{ old('final_result') === 'requires_reassessment' ? 'selected' : '' }}>Requires Reassessment</option>
                            </select>
                            @error('final_result')
                        ...
                        <div>
                            ...
                            <textarea id="executive_summary" name="executive_summary" rows="4" required
                                class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none @error('executive_summary') border-red-500 @enderror">{{ old('executive_summary') }}</textarea>
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        ...
                        <div>
                            ...
                            <textarea id="key_strengths" name="key_strengths[]" rows="3" placeholder="Enter key strengths (one per line)"
                                class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none @error('key_strengths') border-red-500 @enderror">{{ old('key_strengths.0') }}</textarea>
                            @error('key_strengths')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <textarea id="development_areas" name="development_areas[]" rows="3" placeholder="Enter areas for development (one per line)"
                                class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none @error('development_areas') border-red-500 @enderror">{{ old('development_areas.0') }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea id="overall_performance_notes" name="overall_performance_notes" rows="3"
                                class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none @error('overall_performance_notes') border-red-500 @enderror">{{ old('overall_performance_notes') }}</textarea>
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        ...
                        <div>
                            ...
                            <textarea id="recommendations" name="recommendations[]" rows="3" placeholder="Enter recommendations (one per line)"
                                class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none @error('recommendations') border-red-500 @enderror">{{ old('recommendations.0') }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea id="next_steps" name="next_steps" rows="3"
                                class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none @error('next_steps') border-red-500 @enderror">{{ old('next_steps') }}</textarea>
                            @error('next_steps')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <textarea id="reassessment_plan" name="reassessment_plan" rows="3"
                                class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none @error('reassessment_plan') border-red-500 @enderror">{{ old('reassessment_plan') }}</textarea>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="date" id="certification_expiry_date" name="certification_expiry_date" value="{{ old('certification_expiry_date') }}"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" id="certification_level" name="certification_level" value="{{ old('certification_level') }}"
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sticky top-0">
                    ...
                    <div class="mt-6 pt-6 border-t border-gray-200">
                        ...
                        <p class="text-sm text-gray-600 mt-2">
                            Result number and certificate number (if applicable) will be auto-generated.
                        </p>
                    </div>
                </div>
