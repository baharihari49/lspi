...
@section('page_description', 'Create a new payment method')
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <select name="category" required
                                ...
                                <option value="e_wallet" {{ old('category') === 'e_wallet' ? 'selected' : '' }}>E-Wallet</option>
                                <option value="qris" {{ old('category') === 'qris' ? 'selected' : '' }}>QRIS</option>
                                <option value="virtual_account" {{ old('category') === 'virtual_account' ? 'selected' : '' }}>Virtual Account</option>
                                <option value="credit_card" {{ old('category') === 'credit_card' ? 'selected' : '' }}>Credit Card</option>
                                <option value="debit_card" {{ old('category') === 'debit_card' ? 'selected' : '' }}>Debit Card</option>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="gateway_code" value="{{ old('gateway_code') }}"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"
                    ...
                    <div class="space-y-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" name="admin_fee_percentage" value="{{ old('admin_fee_percentage', 0) }}" step="0.01" min="0" max="100" required
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none">
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Admin Fee Fixed (Rp) <span class="text-red-600">*</span></label>
                                <input type="number" name="admin_fee_fixed" value="{{ old('admin_fee_fixed', 0) }}" step="1" min="0" required
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none">
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Min Amount (Rp)</label>
                                <input type="number" name="min_amount" value="{{ old('min_amount') }}" step="1" min="0"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none">
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Max Amount (Rp)</label>
                                <input type="number" name="max_amount" value="{{ old('max_amount') }}" step="1" min="0"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none">
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div>
                        ...
                        <textarea name="instructions" rows="5"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"
                            placeholder="Step-by-step payment instructions for users">{{ old('instructions') }}</textarea>
                    </div>
                </div>
            </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="number" name="display_order" value="{{ old('display_order', 1) }}" min="1" required
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none">
                        </div>
                        ...
                        <div class="flex items-center gap-2">
                            <input type="checkbox" name="requires_manual_verification" id="requires_manual_verification" value="1" {{ old('requires_manual_verification') ? 'checked' : '' }}
                                class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-2 focus:ring-blue-500">
